...
const SLIDES = [
  ...
  },
  {
    ...
    position: 'center 30%',
    tag:      'The Orbit Experience',
    headline: 'Every detail, considered.',
    body:     'From the first boarding call to the final landing — Air Orbit lives in the details.',
  },
  {
  ...
  },
  {
    ...
    headline: 'Built by emperors. Reached by Orbit.',
  ...
  },
  {
    ...
    body:     'Dravidian stone, Carnatic rhythms, Marina mornings. Chennai runs deep — and Orbit puts you right at its heart.',
  },
];
