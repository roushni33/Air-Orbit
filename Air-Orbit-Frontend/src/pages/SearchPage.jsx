...
export default function SearchPage() {
  ...
  return (
    <main>
      ...
      {/* ── Hero — "Choose Air Orbit for..." on the plane ── */}
      <section
        className="relative"
        style={{
          marginTop: '-64px',
      ...
      >
        ...
        <div className="max-w-[1100px] mx-auto px-5 sm:px-8 pt-28 sm:pt-36 pb-14 sm:pb-24 relative select-none">
          ...
          {/* "Choose Air Orbit / for [rotating reason]" — identical to the dark section below */}
              ...
              >
                ...
                style={{ gridTemplateColumns: '100px 1fr auto' }}>
                  ...
                  <div className="font-display text-[16px] sm:text-[18px] tracking-tight text-aa-ink">
                    {r.fromCity}
                    <span className="text-aa-mist mx-2 font-body text-sm">â†’</span>
                    {r.toCity}
                  </div>
